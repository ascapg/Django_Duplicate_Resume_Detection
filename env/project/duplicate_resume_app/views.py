...
def details(request,str):
  fl_path = r"C:\Users\AKSHISHI\OneDrive - Capgemini\Documents\CV_datasets"+str
  filename = str
...
def handle_uploaded_file(file, filename):
    with open(r"C:\Users\AKSHISHI\OneDrive - Capgemini\Documents\CV_datasets" + filename, 'wb+') as destination:
        for chunk in file.chunks():
            destination.write(chunk)

def read_files():
    dirname=r"C:\Users\AKSHISHI\OneDrive - Capgemini\Documents\CV_datasets"
    ext=('.docx','.pdf') 
    L1=[] 
    L2=[] 
    L3=[] 
...
def extraction1(f1_path):
    email_list=[]
    path = r"C:\Users\AKSHISHI\OneDrive - Capgemini\Documents\CV_datasets\\"
...
def saveplot(a):
    return plt.savefig(r"C:\Users\AKSHISHI\OneDrive - Capgemini\Documents\Identical"+str(a)+".png"),"bar"+str(a)+".png"
